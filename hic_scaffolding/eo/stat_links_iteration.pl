...
my $stat_read = shift || die "perl $0 PEread_info cluster_info OUT_file!\n";
###stat_read format: reads chr1 position1 chr2 position2
my $cluster = shift || die "perl $0 PEread_info cluster_info OUT_file!\n";
###cluster format: contig  cluster
my $out = shift || die "perl $0 PEread_info cluster_info OUT_file!\n" ;
